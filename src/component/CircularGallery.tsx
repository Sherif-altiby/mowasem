...
export default function CircularGallery({
  ...
  // Only recreate app when items actually change (deep comparison)
  ...
  useEffect(() => {
    ...
    // Clean up existing app instance before creating new one
    if (appRef.current) {
  ...
  }, [itemsKey, bend, borderRadius, scrollSpeed, scrollEase]);
